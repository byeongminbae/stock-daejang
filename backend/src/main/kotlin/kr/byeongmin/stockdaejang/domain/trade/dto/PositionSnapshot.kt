...
import kr.byeongmin.stockdaejang.domain.common.util.divideRoundHalfUp
...
data class PositionSnapshot(
	...
	fun isExceedQuantity(quantity: BigDecimal): Boolean {
	...
	fun boughtCostFor(quantity: BigDecimal): BigDecimal {
		return remainingCostSnapshot
			.multiplyRounded(quantity)
			.divideRoundHalfUp(remainingQuantitySnapshot)
	}
